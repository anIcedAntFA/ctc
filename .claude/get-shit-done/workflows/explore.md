...
```bash
node "/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
