...
- **Global scope**: `/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/notes/`)
...
2. Glob `/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/notes/` — works in any directory
