...
- Usage: Reference from command with `@/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
