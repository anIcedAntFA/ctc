...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude
                  → checks /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done
                  → writes to /home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/hooks/
...
@/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/ngockhoi96/workspace/github.com/anIcedAntFA/cttc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
