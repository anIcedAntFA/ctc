---
"@ngockhoi96/ctc-vue": "minor"
---

feat(vue): initial release of `@ngockhoi96/ctc-vue` — Vue 3 composable for clipboard copy
...
const { copy, copied, error } = useCopyToClipboard("Hello, world!", { timeout: 1500 });
</script>
